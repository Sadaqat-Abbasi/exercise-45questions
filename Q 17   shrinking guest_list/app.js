...
while (guest_list.length > 2) {
    var remove_guests = guest_list.pop();
    console.log("mr ".concat(remove_guests, " you are not invited on dinner tomorrow"));
}
for (var i = 0; i < guest_list.length; i++) {
    console.log("respected ".concat(guest_list[i], ", we still invited you on dinner"));
}
;
